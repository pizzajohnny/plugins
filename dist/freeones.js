  ...
  return Object.keys(attributes)
    .map(function (key) {
      ...
      return (
        key +
        '="' +
        (opts.decodeEntities ? lib$2.encodeXML(value) : value.replace(/"/g, "&quot;")) +
        '"'
      );
    })
    .join(" ");
...
function renderTag(elem, opts) {
  ...
  if (opts.xmlMode === "foreign") {
    ...
    elem.name =
      (_a = foreignNames.elementNames.get(elem.name)) !== null && _a !== void 0 ? _a : elem.name;
    ...
    while (selector !== "") {
      ...
      if (isWhitespace(firstChar)) {
        ...
        if (firstChar in attribSelectors) {
          ...
          if (
            (_a = options.lowerCaseAttributeNames) !== null && _a !== void 0 ? _a : !options.xmlMode
          ) {
...
var traversal = createCommonjsModule(function (module, exports) {
  ...
  function nextElementSibling(elem) {
    var _a;
    var next = elem.next;
    while (next !== null && !tagtypes.isTag(next)) (_a = next), (next = _a.next);
    return next;
  }
  ...
  function prevElementSibling(elem) {
    var _a;
    var prev = elem.prev;
    while (prev !== null && !tagtypes.isTag(prev)) (_a = prev), (prev = _a.prev);
    return prev;
  }
...
var querying = createCommonjsModule(function (module, exports) {
  ...
  function existsOne(test, nodes) {
    return nodes.some(function (checked) {
      return (
        ...
        (test(checked) || (checked.children.length > 0 && existsOne(test, checked.children)))
      );
    });
  }
  ...
  function findAll(test, nodes) {
    ...
    while ((elem = stack.shift())) {
      var children =
        (_a = elem.children) === null || _a === void 0 ? void 0 : _a.filter(tagtypes.isTag);
    ...
    link: function (elem, options) {
      ...
      return (
        ((_b = (_a = options.adapter).isVisited) === null || _b === void 0
          ? void 0
          : _b.call(_a, elem)) !== true && exports.pseudos["any-link"](elem, options)
      );
    },
    /*
     * Forms
...
var lib$8 = createCommonjsModule(function (module, exports) {
  ...
  function filterParsed(selector, elements, options) {
    ...
    var _a = helpers$1.groupSelectors(selector),
      plainSelectors = _a[0],
  ...
  function select(selector, root, options) {
    ...
    var _a = helpers$1.groupSelectors(lib$4.parse(selector, options)),
      plain = _a[0],
      filtered = _a[1];
...
function toChar(cp) {
  ...
  cp -= 0x10000;
  return (
    String.fromCharCode(((cp >>> 10) & 0x3ff) | 0xd800) + String.fromCharCode(0xdc00 | (cp & 0x3ff))
  );
}
...
var Tokenizer$1 = /** @class */ (function () {
  function Tokenizer(options, cbs) {
    ...
    this.decodeEntities =
      (_a = options === null || options === void 0 ? void 0 : options.decodeEntities) !== null &&
      _a !== void 0
        ? _a
        : true;
  }
...
var Parser_1 = createCommonjsModule(function (module, exports) {
  ...
  var Parser = /** @class */ (function () {
    function Parser(cbs, options) {
      ...
      this.tokenizer = new ((_c = options.Tokenizer) !== null && _c !== void 0
        ? _c
        : Tokenizer_1$1.default)(this.options, this);
...
var traversing = createCommonjsModule(function (module, exports) {
  ...
  exports.parentsUntil = function (selector, filter) {
    ...
    if (typeof selector === "string") {
      untilNode = lib$8.select(selector, this.parents().toArray(), this.options)[0];
    ...
    return this._make(filter ? lib$8.select(filter, parentNodes, this.options) : parentNodes);
  };
...
var manipulation$1 = createCommonjsModule(function (module, exports) {
  ...
  exports.html = function (str) {
    ...
    domEach(this, function (i, el) {
      ...
      var content = str.cheerio ? str.clone().get() : parse$1("" + str, opts, false).children;
...
var cheerio = createCommonjsModule(function (module) {
   ...
   * The API
   */
  var api = [attributes$2, traversing, manipulation$1, css, forms];
...
var _static = createCommonjsModule(function (module, exports) {
  ...
  function render(that, dom, options) {
    ...
    return lib$9.serialize({ children: nodes }, { treeAdapter: lib });
  }
...
var license = "MIT";
var keywords = ["htmlparser", "jquery", "selector", "scraper", "parser", "html"];
var repository = {
  type: "git",
...
var files = ["index.js", "types/index.d.ts", "lib"];
var engines = {
  node: ">= 0.12",
};
var dependencies = {
...
var require$$1$1 = {
  ...
  prettier: prettier,
  "lint-staged": {
    "*.js": ["prettier --write", "npm run test:lint -- --fix"],
    "*.{json,md,ts,yml}": ["prettier --write"],
  },
  _resolved: _resolved,
...
var authors = ["boi123212321", "john4valor", "pizzajohnny", "leadwolf"];
var description$1 = "Scrape actress data from freeones.com";
var pluginEvents = ["actorCreated", "actorCustom"];
var require$$1$2 = {
  name: name$1,
  version: version$1,
  authors: authors,
  ...
  arguments: [
    ...
    },
    {
      ...
      default: [],
      description:
        "Array of data fields to pick (possible values: 'nationality', 'zodiac', 'aliases', 'height', 'weight', 'avatar', 'bornOn', 'labels', 'hair color', 'eye color', 'ethnicity', 'birthplace', 'measurements', 'tattoos', 'piercings')",
    },
    {
      name: "blacklist",
      type: "String[]",
    ...
    },
    {
      ...
      default: "relevance",
      description:
        "Specify the search result sort order key to use. Advanced setting: use only if you know what you are doing. Possible values are 'relevance', 'rank.currentRank', 'followerCount', 'profileCompleted' or 'views'",
    },
    {
      name: "useImperial",
      type: "Boolean",
    ...
    },
    {
      ...
      default: "string",
      description:
        "How to return the piercings. Use 'array' if your custom field is a select or multi select",
    },
    {
      name: "tattoosType",
      type: "'string' | 'array'",
      ...
      default: "string",
      description:
        "How to return the tattoos. Use 'array' if your custom field is a select or multi select",
    },
  ],
};
...
const info_json_1 = __importDefault$2(require$$1$2);
...
const handler = (ctx) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const href =
      (_a = firstResult.attr("href")) === null || _a === void 0 ? void 0 : _a.replace("/feed", "");
    let html;
    try {
    ...
    const data = Object.assign(
      Object.assign(
        Object.assign(Object.assign(Object.assign({}, getNationality()), getAge()), getAlias()),
        yield getAvatar()
      ),
      { custom }
    );
