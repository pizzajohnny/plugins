  ...
  function scanFolder(ctx, query, scrapeDefinition) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        cb: (imagePath) =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            const pathToMatch = scrapeDefinition.mustMatchInFilename
              ...
              : imagePath;
            const isMatch =
              ctx.$matcher.filterMatchingItems(itemsToMatch, pathToMatch, (el) => [el.name])
                .length === itemsToMatch.length &&
              !ctx.$matcher.filterMatchingItems(blacklistedItems, pathToMatch, (el) => [el.name])
                .length;
            if (!isMatch) {
              return;
            }
      ...
      if (!foundImagePaths.length) {
        ctx.$logger.verbose(
          `No "${scrapeDefinition.prop}" pictures of "${query}" in "${queryPath}"`
        );
        return {};
      }
      ctx.$logger.verbose(
...
var name = "pics";
var version = "2.2.0";
var authors = ["boi123212321", "john4valor", "leadwolf"];
...
var require$$0 = {
  ...
  arguments: [
    ...
    },
    {
      ...
      default: "thumbnail",
      description:
        "The type of picture that should be attached to the actor. Set to `'extra'` to add any image you want to the gallery",
    },
    {
      name: "actors.[0].path",
      type: "string",
    ...
    },
    {
      ...
      default: false,
      description:
        "If the name of the actor and the `searchTerms` must be matched against the filename, instead of the file path",
    },
    {
      name: "actors.[0].max",
      type: "number",
      ...
      default: -1,
      description:
        "Only needed for an `'extra'` search configuration: how many max images to get. Do not define or use a negative number to get all. You can otherwise omit this property",
    },
    {
      name: "scenes",
      type: "Array",
    ...
    },
    {
      ...
      default: "thumbnail",
      description:
        "The type of picture that should be attached to the scene. Set to `'extra'` to add any image you want to the gallery",
    },
    {
      name: "scenes.[0].path",
      type: "string",
    ...
    },
    {
      ...
      default: false,
      description:
        "If the name of the scene and the `searchTerms` must be matched against the filename, instead of the file path",
    },
    {
      name: "scenes.[0].max",
      type: "number",
    ...
    },
    {
      ...
      default: "thumbnail",
      description:
        "The type of picture that should be attached to the movie. Set to `'extra'` to add any image you want to the gallery",
    },
    {
      name: "movies.[0].path",
      type: "string",
    ...
    },
    {
      ...
      default: false,
      description:
        "If the name of the movie and the `searchTerms` must be matched against the filename, instead of the file path",
    },
    {
      name: "movies.[0].max",
      type: "number",
    ...
    },
    {
      ...
      default: "thumbnail",
      description:
        "The type of picture that should be attached to the studio. Set to `'extra'` to add any image you want to the gallery",
    },
    {
      name: "studios.[0].path",
      type: "string",
    ...
    },
    {
      ...
      default: false,
      description:
        "If the name of the studio and the `searchTerms` must be matched against the filename, instead of the file path",
    },
    {
      name: "studios.[0].max",
      type: "number",
