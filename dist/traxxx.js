...
var studio = createCommonjsModule(function (module, exports) {
  ...
  class ChannelExtractor {
    ...
    _getName() {
      ...
      const baseName =
        (_b = (_a = this.preferredEntity) === null || _a === void 0 ? void 0 : _a.entity) ===
          null || _b === void 0
          ? void 0
          : _b.name;
      if (!baseName) {
      ...
      const ignoreNameConflicts =
        ((_c = this.channel) === null || _c === void 0 ? void 0 : _c.name) !==
          ((_d = this.network) === null || _d === void 0 ? void 0 : _d.name) ||
      ...
      let suffix = "";
      if (
        ((_e = this.preferredEntity) === null || _e === void 0 ? void 0 : _e.type) === "channel"
      ) {
        suffix = this.ctx.args.studios.channelSuffix;
      } else if (
        ((_f = this.preferredEntity) === null || _f === void 0 ? void 0 : _f.type) === "network"
      ) {
    ...
    getAliases() {
      ...
      if (
        (previousAliases === null || previousAliases === void 0
          ? void 0
          : previousAliases.length) &&
        this.ctx.args.studios.mergeAliases
      ) {
        return {
    ...
    getParent() {
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if (
          ((_e = (_d = this.preferredEntity) === null || _d === void 0 ? void 0 : _d.entity) ===
            null || _e === void 0
            ? void 0
            : _e.name) === parentName
        ) {
        ...
        const parentSlug =
          (_h =
            (_g = (_f = this.preferredEntity) === null || _f === void 0 ? void 0 : _f.entity) ===
              null || _g === void 0
              ? void 0
              : _g.parent) === null || _h === void 0
            ? void 0
            : _h.slug;
        if (!parentSlug) {
        ...
        const {
          channel: parentAsChannel,
          network: parentAsNetwork,
        } = yield this.api.getAllEntities(parentSlug);
        if (
          (parentAsChannel === null || parentAsChannel === void 0
            ? void 0
            : parentAsChannel.name) ===
          (parentAsNetwork === null || parentAsNetwork === void 0 ? void 0 : parentAsNetwork.name)
        ) {
          if (this.ctx.args.studios.uniqueNames) {
            return { parent: `${parentName}${this.ctx.args.studios.networkSuffix}` };
          }
      ...
      return {
        "Traxxx Slug":
          (_b = (_a = this.preferredEntity) === null || _a === void 0 ? void 0 : _a.entity) ===
            ...
            : _b.slug,
        "Traxxx Type":
          (_d = (_c = this.preferredEntity) === null || _c === void 0 ? void 0 : _c.entity) ===
            null || _d === void 0
            ? void 0
            : _d.type,
        Homepage:
          (_f = (_e = this.preferredEntity) === null || _e === void 0 ? void 0 : _e.entity) ===
            null || _f === void 0
            ? void 0
            : _f.url,
      };
      ...
      const result = Object.assign(
        Object.assign(
          Object.assign(
            Object.assign(
              Object.assign(
                Object.assign({}, channelExtractor.getName()),
                channelExtractor.getDescription()
              ),
              yield channelExtractor.getThumbnail()
            ),
            channelExtractor.getAliases()
          ),
          yield channelExtractor.getParent()
        ),
...
var name = "traxxx";
var version = "0.2.0";
var authors = ["leadwolf"];
var description = "Scrape data from traxxx";
var pluginEvents = ["studioCreated", "studioCustom"];
var require$$1 = {
  name: name,
  version: version,
  authors: authors,
  ...
  arguments: [
    ...
    },
    {
      ...
      default: true,
      description:
        "When the studio type is unknown, and the name corresponds to both a channel & a network, whether to prefer the channel or the network",
    },
    {
      ...
      default: true,
      description:
        "When the studio name corresponds to both a channel & a network, whether to append suffixes to the name to avoid conflicts. The suffixes obviously cannot be the same. If the studio name already has a suffix, it will be kept, even if this setting is false",
    },
    {
      ...
      default: " (Channel)",
      description:
        "When `studios.uniqueNames` is active returning a **channel** name that also corresponds to a network, will be appended to the name. WARNING: spaces between the name & suffix will not be automatically added",
    },
    {
      ...
      default: " (Network)",
      description:
        "When `studios.uniqueNames` is active and returning a **network** name that also corresponds to a channel, will be appended to the name. WARNING: spaces between the name & suffix will not be automatically added",
    },
    {
      ...
      default: true,
      description:
        "When the previous plugin returned aliases, if our plugins aliases should be merged with them or override them",
    },
    {
      ...
      default: [],
      description:
        "Array of data fields to pick. When non empty, only the fields listed will be returned. Possible values: [`'name', 'description', 'thumbnail', 'aliases', 'parent'`].",
    },
    {
      ...
      default: [],
      description:
        "Array of data fields to omit. Used **only** when `whitelist` is empty. When non empty, only the fields **not** listed will be returned. (for values see `whitelist`)",
    },
    {
      ...
      default: [],
      description:
        "Array of data fields to pick, when values already exist from a piped plugin. Acts exactly the same as `whitelist`, but used **only** when the field has been returned by a previous plugin. (**WARNING**: not the same thing as existing values of the scene) (for values see `whitelist`)",
    },
    {
      ...
      default: [],
      description:
        "Array of data fields to omit, when values already exist from a a piped plugin. Acts exactly the same as `blacklist`, but used **only** when the field has been returned by a previous plugin.  (**WARNING**: not the same thing as existing values of the scene) (for values see `whitelist`)",
    },
  ],
};
