...
var template = createCommonjsModule(function (module, exports) {
  ...
  function getTemplateFieldsResolvers(ctx) {
    ...
    return [
      ...
      },
      {
        ...
        getPluginData: (i) =>
          __awaiter(this, void 0, void 0, function* () {
            return data.releaseDate ? $moment(data.releaseDate).format(args.dateFormat) : undefined;
          }),
        getInitialData: (i) =>
          __awaiter(this, void 0, void 0, function* () {
            return scene.releaseDate
              ? $moment(scene.releaseDate).format(args.dateFormat)
              : undefined;
          }),
      },
      {
        ...
        getPluginData: (i) =>
          __awaiter(this, void 0, void 0, function* () {
            var _a;
            return (_a = data.rating) === null || _a === void 0 ? void 0 : _a.toString();
          }),
        getInitialData: (i) =>
          __awaiter(this, void 0, void 0, function* () {
            var _b;
            return (_b = scene.rating) === null || _b === void 0 ? void 0 : _b.toString();
          }),
      },
      {
        ...
        getInitialData: (i) =>
          __awaiter(this, void 0, void 0, function* () {
            var _c, _d, _e;
            return (_e =
              (_d = (_c = scene.meta) === null || _c === void 0 ? void 0 : _c.dimensions) ===
                null || _d === void 0
                ? void 0
                : _d.height) === null || _e === void 0
              ? void 0
              : _e.toString();
          }),
      },
      {
        ...
        getInitialData: (i) =>
          __awaiter(this, void 0, void 0, function* () {
            var _f, _g, _h;
            return (_h =
              (_g = (_f = scene.meta) === null || _f === void 0 ? void 0 : _f.dimensions) ===
                null || _g === void 0
                ? void 0
        ...
        getInitialData: (i) =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            return formatVideoDuration(
              $moment,
              (_j = scene.meta) === null || _j === void 0 ? void 0 : _j.duration
            );
          }),
      },
      {
  ...
  function getAndValidateFieldArgs(args) {
    ...
    for (const match of matches) {
      ...
      if ((_c = match.groups) === null || _c === void 0 ? void 0 : _c.mandatory) isMandatory = true;
      isValid = true;
    }
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (
        ...
        fieldValue !== null && fieldValue !== void 0
          ? fieldValue
          : (fieldValue = yield resolver.getInitialData(index));
      }
      return fieldValue;
    });
  }
...
var require$$0 = {
  ...
  arguments: [
    ...
    },
    {
      ...
      default: "rename",
      description:
        "Behavior in case of name conflicts. Possible values are: `rename` and `skip`. With `rename`, the new filename is suffixed with a number so that it does not conflict with an existing name anymore. With `skip`, the rename operation is cancelled.",
    },
    {
      name: "dateFormat",
      type: "String",
      ...
      default: "YYYY-MM-DD",
      description:
        "The date format to use in file names. The full details are available at https://momentjs.com/docs/#/displaying/format/ although you probably just need `YYYY`, `MM` and `DD`.",
    },
    {
      ...
      default: ", ",
      description:
        "The separator to use for multiple values (like actors, labels,...). For instance, with a `', '` as separator, a list of 3 labels will look like: `label1, label2, label3`.",
    },
    {
      ...
      description:
        "Used to substitute characters with a replacement alternative. See doc above for details. Note: the examples below looks like it is replacing a colon by a colon, but it is actually replacing the colon (illegal in filenames) by the similar looking 'mathematical ratio' character (allowed in filenames)",
    },
  ],
};
...
function filenameMaker(ctx, template$1) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    for (const match of matches) {
      const resolver = fieldResolvers.find((item) => {
        var _a, _b;
        return (
          item.name.toLowerCase() ===
          ((_b = (_a = match.groups) === null || _a === void 0 ? void 0 : _a.field) === null ||
          _b === void 0
            ? void 0
            : _b.toLowerCase())
        );
      });
      const fieldArgs = template.getAndValidateFieldArgs(
        (_a = match.groups) === null || _a === void 0 ? void 0 : _a.args
      );
      if (!resolver || !fieldArgs.isValid) {
        $logger.error(
          `Unsupported field ${
            (_b = match.groups) === null || _b === void 0 ? void 0 : _b.field
          } (or its arguments) in template ${template$1}`
        );
        return;
      }
      ...
      if (fieldValue) {
        const groupOutput = `${
          (_c = match.groups) === null || _c === void 0 ? void 0 : _c.prefix
        }${fieldValue}${(_d = match.groups) === null || _d === void 0 ? void 0 : _d.suffix}`;
        result += groupOutput;
    ...
    if (result) {
      ...
      $logger.warn(
        `Could not generate a new filename based on template: '${template$1}'. All the template fields were without value.`
      );
    }
  });
}
