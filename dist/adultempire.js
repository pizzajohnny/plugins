...
function default_1(ctx) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const name = actorName
      ...
      .trim();
    $logger.info(
      `Scraping actor info for '${name}', dry mode: ${
        (args === null || args === void 0 ? void 0 : args.dry) || false
      }...`
    );
...
function default_1$1(ctx) {
  return __awaiter$1(this, void 0, void 0, function* () {
    ...
    const name = movieName
      ...
      .trim();
    $logger.info(
      `Scraping movie covers for '${name}', dry mode: ${
        (args === null || args === void 0 ? void 0 : args.dry) || false
      }...`
    );
...
var version$1 = "0.5.0";
var authors = ["boi123212321"];
var description$1 = "Scrape data from adultempire";
var pluginEvents = ["movieCreated", "actorCreated"];
var require$$2$1 = {
  name: name$1,
  version: version$1,
  authors: authors,
...
const info_json_1 = __importDefault$4(require$$2$1);
const handler = (ctx) =>
