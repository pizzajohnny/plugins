...
var util = createCommonjsModule(function (module, exports) {
  ...
  function escapeRegExp(string) {
    var _a;
    return (_a =
      string === null || string === void 0
        ? void 0
        : string.replace(/[.*+\-?^${}()|[\]\\]/g, "\\$&")) !== null && _a !== void 0
      ? _a
      : "";
  }
  exports.escapeRegExp = escapeRegExp;
  const createQuestionPrompter = (inquirer, testingStatus, $logger) => {
    const questionAsync = (promptArgs) =>
  ...
  const matchSceneResultToSearch = (ctx, sceneList, knownActors, studio) => {
    ...
    for (const scene of sceneList) {
      ctx.$logger.verbose(
        `MATCH:\tTrying to match TPD title: ${JSON.stringify(
          scene.title
  ...
  function checkActorMatch(performers, actors) {
    ...
    if (
      (performers === null || performers === void 0 ? void 0 : performers.length) &&
      (actors === null || actors === void 0 ? void 0 : actors.length)
    ) {
  ...
  const matchSceneResultToPipedData = (ctx, sceneList) => {
    ...
    for (const scene of sceneList) {
      ...
      const searchedTitle = stripStr(
        (_b = (_a = data.name) !== null && _a !== void 0 ? _a : data.movie) !== null &&
          _b !== void 0
          ? _b
          : ""
      ).trim();
      ...
      ctx.$logger.verbose(
        `MATCH PIPED: Trying to match TPD scene:\n${$formatMessage({
          ...
          title: foundTitle,
          actors:
            (_d = scene.performers) === null || _d === void 0
              ? void 0
              : _d.map((performer) => performer.name),
  ...
  const checkSceneExistsInDb = (ctx, sceneTitle) => {
    ...
    if (
      !sceneTitle ||
      !((_a = ctx.args) === null || _a === void 0 ? void 0 : _a.sceneDuplicationCheck) ||
      !((_c = (_b = ctx.args) === null || _b === void 0 ? void 0 : _b.source_settings) === null ||
      _c === void 0
        ? void 0
        : _c.scenes)
    ) {
...
var parse = createCommonjsModule(function (module, exports) {
  ...
  const parseSceneActor = (ctx) => {
    var _a, _b, _c;
    if (
      !((_a = ctx.args) === null || _a === void 0 ? void 0 : _a.parseActor) ||
      !((_c = (_b = ctx.args) === null || _b === void 0 ? void 0 : _b.source_settings) === null ||
      _c === void 0
        ? void 0
        : _c.actors)
  ...
  const parseSceneStudio = (ctx) => {
    var _a, _b, _c;
    if (
      !((_a = ctx.args) === null || _a === void 0 ? void 0 : _a.parseStudio) ||
      !((_c = (_b = ctx.args) === null || _b === void 0 ? void 0 : _b.source_settings) === null ||
      _c === void 0
        ? void 0
        : _c.studios)
    ...
    ctx.$logger.verbose(
      `Parsing Studios DB ==> ${JSON.stringify(ctx.args.source_settings.studios)}`
    );
    const cleanScenePath = util.stripStr(ctx.scenePath);
    const allDbStudios = [];
    ...
    ctx.$logger.verbose(
      `\tUsing "best match" Studio For Search: ${JSON.stringify(parsedDbStudio)}`
    );
...
var version = "0.4.0";
var authors = ["Ch00nassid a.k.a: DGs.Ch00", "leadwolf"];
var description = "Ask questions and make sure scene parsing is correct";
var pluginEvents = ["sceneCreated", "sceneCustom"];
var require$$0 = {
  name: name,
  version: version,
  authors: authors,
  ...
  arguments: [
    {
      ...
      default: false,
      description:
        "When searching TPDB: in auto search, if should use existing scene title. In manual user search, if should prompt user for title and use in search",
    },
    {
      ...
      default: false,
      description:
        "When searching TPDB, if there is **only** 1 result, even if its title **doesn't** match the searched title, if should return that data",
    },
    {
      ...
      default: false,
      description:
        "This option is only relevant when PromisedScene is chained from another plugin (piped data are set). If true, the piped data take precedence for the search. If false, the piped data are ignored.",
    },
    {
      name: "parseActor",
      type: "Boolean",
    ...
    },
    {
      ...
      default: true,
      description:
        "If true, will allow you to answer questions to manually enter scene data, manually search TPDB, confirm the final result",
    },
    {
      ...
      default: true,
      description:
        "Will notify you of a possible duplicate title that is being imported.  Will not currently stop / correct anything",
    },
    {
      ...
      description:
        "finds the DB file for Actors to determine which actors are currently in your collection",
    },
    {
      ...
      description:
        "finds the DB file for Studios to determine which Studios are currently in your collection",
    },
    {
      ...
      description:
        "finds the DB file for Scenes to determine which Scenes are currently in your collection",
    },
  ],
};
...
const handler = (ctx) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    searchTimestamp !== null && searchTimestamp !== void 0
      ? searchTimestamp
      : (searchTimestamp =
          (_d =
            (_c = scene.releaseDate) !== null && _c !== void 0
              ? _c
              : parse.parseSceneTimestamp(ctx)) !== null && _d !== void 0
            ? _d
            : undefined);
    searchStudio !== null && searchStudio !== void 0
      ? searchStudio
      : (searchStudio =
          (_f = (_e = yield ctx.$getStudio()) === null || _e === void 0 ? void 0 : _e.name) !==
            null && _f !== void 0
            ? _f
            : parse.parseSceneStudio(ctx));
    if (!searchActors.length) {
      searchActors =
        (_h =
          (_g = yield ctx.$getActors()) === null || _g === void 0
            ? void 0
            : _g.map((a) => a.name)) !== null && _h !== void 0
          ? _h
          : [];
      if (!searchActors.length) {
    ...
    userMovie !== null && userMovie !== void 0
      ? userMovie
      : (userMovie =
          (_k = (_j = yield ctx.$getMovies()) === null || _j === void 0 ? void 0 : _j[0]) ===
            null || _k === void 0
            ? void 0
            : _k.name);
    ...
    function logResultObject(results) {
      ...
      if (logObj.releaseDate) {
        logObj.releaseDate = util.timestampToString(
          (_a = logObj.releaseDate) !== null && _a !== void 0 ? _a : 0
        );
      }
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(args === null || args === void 0 ? void 0 : args.manualTouch)) {
          if (sceneData.thumbnail) {
            try {
              sceneData.thumbnail = yield $createImage(
                sceneData.thumbnail,
                sceneData.name || "",
                true
              );
        ...
        const questionAsync = util.createQuestionPrompter(
          $inquirer,
          testMode === null || testMode === void 0 ? void 0 : testMode.status,
          $logger
        );
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const { isMovie: manualMovieAnswer } = yield questionAsync({
          ...
          testAnswer:
            (_b =
              (_a =
                testMode === null || testMode === void 0 ? void 0 : testMode.questionAnswers) ===
                null || _a === void 0
                ? void 0
                : _a.enterMovie) !== null && _b !== void 0
              ? _b
              : "",
        });
          ...
          testAnswer:
            (_f =
              (_e =
                ...
                null || _e === void 0
                ? void 0
                : _e.enterSceneTitle) !== null && _f !== void 0
              ? _f
              : "",
        });
          ...
          testAnswer:
            (_h =
              (_g =
                ...
                null || _g === void 0
                ? void 0
                : _g.enterSceneDate) !== null && _h !== void 0
              ? _h
              : "",
        });
          ...
          testAnswer:
            (_k =
              (_j =
                ...
                null || _j === void 0
                ? void 0
                : _j.manualDescription) !== null && _k !== void 0
              ? _k
              : "",
        });
          ...
          testAnswer:
            (_m =
              (_l =
                ...
                null || _l === void 0
                ? void 0
                : _l.manualActors) !== null && _m !== void 0
              ? _m
              : "",
          default() {
          ...
          testAnswer:
            (_p =
              (_o =
                ...
                null || _o === void 0
                ? void 0
                : _o.enterStudioName) !== null && _p !== void 0
              ? _p
              : "",
          default() {
    ...
    function getNextSearchChoices() {
      ...
      return __awaiter(this, void 0, void 0, function* () {
          ...
          testAnswer:
            (_h =
              (_g =
                ...
                null || _g === void 0
                ? void 0
                : _g.enterOneActorName) !== null && _h !== void 0
              ? _h
              : "",
          default() {
            return searchActors ? ` ${searchActors.join(",")}` : "";
          ...
          testAnswer:
            (_k =
              (_j =
                ...
                null || _j === void 0
                ? void 0
                : _j.enterStudioName) !== null && _k !== void 0
              ? _k
              : "",
          default() {
            return searchStudio ? ` ${searchStudio}` : "";
        ...
        const { manualDateSearch: Q4date } = yield questionAsync({
          ...
          message:
            "What is the release date (YYYY.MM.DD / DD.MM.YYYY / YY.MM.DD)?: (Blanks allowed) ",
          testAnswer:
            (_p =
              (_o =
                testMode === null || testMode === void 0 ? void 0 : testMode.questionAnswers) ===
                null || _o === void 0
                ? void 0
                : _o.enterSceneDate) !== null && _p !== void 0
              ? _p
              : "",
          default() {
            if (!searchTimestamp) {
    ...
    function makeChoices() {
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            testAnswer:
              (_b =
                (_a =
                  ...
                  null || _a === void 0
                  ? void 0
                  : _a.enterInfoSearch) !== null && _b !== void 0
                ? _b
                : "",
          ...
          $logger.error(
            `Something went wrong asking for search questions ${$formatMessage(error)}`
          );
        }
        return util.manualTouchChoices.NOTHING;
      });
    ...
    function doASearch({ title, actors, studio, timestamp }) {
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          if (
            !(apiRes === null || apiRes === void 0 ? void 0 : apiRes.data) ||
            (testMode === null || testMode === void 0 ? void 0 : testMode.testSiteUnavailable)
          ) {
        ...
        if (!args.manualTouch) {
          $logger.info(
            "ManualTouch is disabled, cannot automatically choose from multiple results"
          );
          return null;
        }
        $logger.info("#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#");
          ...
          testAnswer:
            (_b =
              (_a =
                ...
                null || _a === void 0
                ? void 0
                : _a.multipleChoice) !== null && _b !== void 0
              ? _b
              : "",
          choices: answersList,
        });
